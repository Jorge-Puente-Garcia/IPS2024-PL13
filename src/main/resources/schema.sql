...
CREATE TABLE Localizacion (id INTEGER PRIMARY KEY AUTOINCREMENT, fila INTEGER NOT NULL, columna INTEGER NOT NULL, estanteria INTEGER NOT NULL, cara CHAR NOT NULL);
